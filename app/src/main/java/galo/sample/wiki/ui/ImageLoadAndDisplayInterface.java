...
public class ImageLoadAndDisplayInterface
{
     ...
     */
    public void setBitmap(Bitmap bmap, boolean animate, boolean recyleBitmapOnRecycleInvocation)
    {
        if(!mRecycled)
        {
    ...
    public void bindImageView(ImageView iv)
    {

        mBoundImageViewWRef = new WeakReference<ImageView>(iv);
        if(iv != null)
        {
            // make sure no other thread can modify the image view.
            Animation prevAnimation = iv.getAnimation();
